<div class="relative border border-white bg-black p-1 text-white">
    ...
    <input wire:model.debounce.500ms="searchNetflix" type="text" placeholder="Titulo, pessoas, generos" class="ml-8 bg-black text-white placeholder-gray-500 focus:outline-none">
